...
ggplot() +
  ...
  # Labeling
  labs(x = 'y-axis label', y = 'y-axis label', subtitle = 'subtitle', title = 'title')
...
There are also a number of pre-set themes such as 'theme_bw()' and 'theme_classic()'. However, for this, I constructed my own theme as 'plot.paper()' and 'plot.presentation()' as settings for papers and presentations, respectively, based on my style preferences.

## Manipulating the figure

Demo of the code to make a labeled figure, showing it for both the presentation and paper themes.
...
ggplot() +
  ...
  geom_point(data = filter(points, !is.na(adj.x)), 
             mapping = aes(x = pka, y = Keq.C25), color = 'steelblue2', size = ptsz) +
...
ggplot() +
  ...
  # Apply the paper theme
  plot.paper()
ggsave(filename = 'Figures/01ScatterExample.jpg', width = 8, height = 6, dpi = 300)
ggsave(filename = 'Figures/01ScatterExample.pdf', width = 8, height = 6, dpi = 300)
ggsave(filename = 'Figures/01ScatterExample.png', width = 8, height = 6, dpi = 300)
ggsave(filename = 'Figures/01ScatterExample.svg', width = 8, height = 6, dpi = 300)
```
...
* Only the bottom and left subplots actually have axes. This is more obvious when applying the 'plot.presentation()' or 'plot.paper()' themes, but evident here.
...
* The panels (subplots) may be too close. Adjust them with 'theme(panel.spacing.y = unit(), panel.spacing.x = unit())', where 'unit()' takes a number followed by the units it should refer to. I recommend applying this after setting the theme functions, as the font sizes have a substantial impact on them. It will also look different if the dimensions of the exported figure are different.
...
ggplot(data) +
  ...
  # y scale
  scale_y_continuous(expand = expansion(mult = c(0, 0.1))) +
  labs(subtitle = 'Applying the Paper Theme + Panel Padding')
ggsave(filename = 'Figures/02BarplotExample.jpg', width = 8, height = 6, dpi = 300)
ggsave(filename = 'Figures/02BarplotExample.pdf', width = 8, height = 6, dpi = 300)
ggsave(filename = 'Figures/02BarplotExample.png', width = 8, height = 6, dpi = 300)
ggsave(filename = 'Figures/02BarplotExample.svg', width = 8, height = 6, dpi = 300)
...
ggplot(data) +
  ...
  labs(subtitle = 'expansion(mult = 0); alpha = 0.25; 5 bins') +
  coord_fixed()
...
ggplot(data) +
  ...
  labs(subtitle = 'expansion(mult = 0.5) for x, mult = 1 for y; alpha = 0.75; 8 bins') +
  coord_fixed()
...
# As before, but the red legend has been eliminated
g2 + g3 + plot_spacer() + g1 + plot_layout(guides = "collect", nrow = 2)
ggsave(filename = 'Figures/03HeatmapExample.jpg', width = 8, height = 6, dpi = 300)
ggsave(filename = 'Figures/03HeatmapExample.pdf', width = 8, height = 6, dpi = 300)
ggsave(filename = 'Figures/03HeatmapExample.png', width = 8, height = 6, dpi = 300)
ggsave(filename = 'Figures/03HeatmapExample.svg', width = 8, height = 6, dpi = 300)
